...
Agenten-IDs: ollama-cloud (primär), inception-mercury (optional), gx10-local (lokal/sensibel)
...
- `/delegate-config enable ollama-cloud` — Agenten aktivieren
- `/delegate-config disable ollama-cloud` — Agenten deaktivieren
